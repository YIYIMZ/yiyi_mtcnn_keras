...
from config import NET_SIZE, BATCH_SIZE, RNET_EPOCHS, RNET_LEARNING_RATE, GAN_DATA_ROOT_DIR

from load_data import load_dataset, DataGenerator
from train_pub import create_callbacks_model_file, train_r_net_with_data_generator

def train_with_data_generator(dataset_root_dir = GAN_DATA_ROOT_DIR, weights_file=None):
    net_name = 'r_net'
    batch_size = BATCH_SIZE
    epochs = RNET_EPOCHS
    learning_rate = RNET_LEARNING_RATE
